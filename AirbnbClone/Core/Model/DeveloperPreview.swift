    ...
    var mockListings: [Listing] = [
        ...
        Listing(id: UUID().uuidString,
            ...
            Listing(id: UUID().uuidString,
                    ...
                    rating: 4.9,
                    features: [.superHost],
                    amenities: [.pool, .wifi, .tv, .balcony],
                    type: .apartment),
            // Listing 6
            Listing(id: UUID().uuidString,
                    ownerUid: "owner6",
                    ...
                    rating: 5.0,
                    features: [.superHost],
                    amenities: [.pool, .wifi, .tv, .alarmSystem, .office, .balcony],
                    type: .villa),
            // Listing 7
            Listing(id:  UUID().uuidString,
                    ownerUid: "owner7",
        ...
        Listing(id: UUID().uuidString,
                ...
                rating: 4.6,
                features: [.selfCheckin],
                amenities: [.wifi,.office,.laundry, .pool],
                type:.townHouse),
